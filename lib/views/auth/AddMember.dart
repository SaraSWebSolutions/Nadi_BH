...
//     final addr = widget.prefilledAddress!;

//     addressController.city.text = addr["city"] ?? "";
//     addressController.building.text = addr["building"] ?? "";
//     addressController.aptNo.text = addr["aptNo"] ?? "";
//     addressController.floor.text = addr["floor"] ?? "";

//     addressController.block = addr["block"];
//     addressController.blockId = addr["blockId"];
//     addressController.road = addr["road"];
//     addressController.roadId = addr["roadId"];
...
//     return familyMembers.where(isMemberComplete).length;
//   }
// void _fillAddressFromPrefilled() {
//   final addr = widget.prefilledAddress;
//   if (addr == null) return;
...
//   title: const Text("Use same address"),
//   value: _useSameAddress,
//   onChanged: (val) {
//     setState(() {
//       _useSameAddress = val ?? false;

//       if (_useSameAddress) {
//         _fillAddressFromPrefilled();
//         _isAddress = true;
//       } else {
//         addressController.clear();
//       }
