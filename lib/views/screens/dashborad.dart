...
Future<void> updateAppBadge(int count) async {
  ...
  Future<void> approvework(bool isApproved) async {
    ...
    try {
      ...
      SnackbarHelper.ShowSuccess(context, "Work approved successfully"); // ignore: use_build_context_synchronously
                              ...
                              Consumer(
                                builder: (context, ref, _) {
                                  ...
                                  notificationCount.whenData((response) {
                                    if (_lastSeenTime == null) {
                                      newNotifications = response.data.length;
                                    } else {
                                  ...
                                  return AnimatedEnvelope(
                                    ...
                                    onTap: () async {
                                      ...
                                      if (context.mounted) {
                                        context.push(RouteNames.pointnodification).then((_) {
                                          AppPreferences.getLastSeenNotificationTime().then((val) {
                                            if (mounted) setState(() => _lastSeenTime = val);
                                          });
                                        });
      ...
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                AppLocalizations.of(context)!.approvalNeeded,
                style: const TextStyle(
                  fontWeight: FontWeight.bold,
      ...
      child: RequestCart(
        ...
        onTap: () {
          showModalBottomSheet(
            ...
            builder: (_) => AddPointBottomSheetContent(accountType: _rawAccountType),
          );
        },
      ),
    ),
